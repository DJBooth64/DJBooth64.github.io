...
function chart(propertiesProvided) {
    ...
    var width = d3.select('#chart2')[0][0].clientWidth - properties.margin.left - properties.margin.right;
    ...
    var svg = d3.select('.chart').text('').append('svg')
        .attr('width', width + properties.margin.left + properties.margin.right+20)
